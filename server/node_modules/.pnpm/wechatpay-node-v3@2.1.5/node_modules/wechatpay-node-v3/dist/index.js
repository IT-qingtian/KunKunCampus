...
var Pay = /** @class */ (function (_super) {
    ...
    Pay.prototype.get_certificates = function (apiSecret) {
        return __awaiter(this, void 0, void 0, function () {
            var url, authorization, result, data, _i, data_1, item, decryptCertificate;
    ...
    Pay.prototype.batches_transfer = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var url, _params, serial_no, authorization;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        authorization = this.init('POST', url, _params);
                        return [4 /*yield*/, this.postRequestV2(url, _params, authorization, { 'Wechatpay-Serial': serial_no || this.serial_no })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        authorization = this.init('GET', url);
                        return [4 /*yield*/, this.getRequestV2(url, authorization)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _params = __assign({}, params);
                        authorization = this.init('POST', url, _params);
                        return [4 /*yield*/, this.postRequestV2(url, _params, authorization)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
